...
public class ADTextView extends View {
    ...
    private void obtainStyledAttrs(AttributeSet attrs) {
        ...
        HeadSize = (int) array.getDimension(R.styleable.ADTextView_ad_text_front_size, SizeUtils.sp2px(15));
        ContentSize = (int) array.getDimension(R.styleable.ADTextView_ad_text_content_size, SizeUtils.sp2px(15));
        ContentPadding = array.getDimension(R.styleable.ADTextView_ad_text_content_padding, SizeUtils.sp2px(10));
        paddingLeft = array.getDimension(R.styleable.ADTextView_ad_text_padding_left, SizeUtils.sp2px(10));
        array.recycle();
    }
